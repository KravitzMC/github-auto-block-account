...
You can use ```sudo crontab -e``` in Linux Shell and set up the Cron Jobs on your required time. Cron Job will execute automatically like task scheduler on windows. 
